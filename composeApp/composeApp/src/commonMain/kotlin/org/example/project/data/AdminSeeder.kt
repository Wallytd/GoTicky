...
// REMOVED: rememberedAdminProfile() and updateAdminRememberMe()
// Admin credentials with rememberMe are now stored locally per device using SecureStorage,
// not in the cloud. This prevents credentials from being exposed on all devices.
