...
private class AndroidEventImageStorage(
    ...
    override suspend fun uploadEventFlyer(
        ...
        val safeEventId = if (eventId.isBlank()) System.currentTimeMillis().toString() else eventId
        val path = "events/$organizerId/flyers/$safeEventId-${System.currentTimeMillis()}.jpg"
...
actual fun rememberEventImageStorage(): EventImageStorage =
    remember { AndroidEventImageStorage() }
